...
using EticaretWebUI.ExtentionMethods;
...
namespace EticaretWebUI.Controllers
{
    public class CartController : Controller
    {
        ...
        public CartController(IService<Product> serviceProduct, IService<Eticaret.Core.Entities.Address> serviceAddress, IService<AppUser> serviceAppUser, IService<Order> serviceOrder, IConfiguration configuration)
        {
