...
namespace EticaretWebUI.Areas.Admin.Controllers
{
    ...
    public class AddressesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,City,District,OpenAddress,IsActive,IsBillingAddress,IsDeliverygAddress,AddressGuid,AppUserId")] Address address)
        {
            if (id != address.Id)
            {
                return NotFound();
